...
interface EditInvoiceModalProps {
  ...
  onConfirm?: (data: InvoiceObj) => Promise<void>;
  title?: string;
  saveLabel?: string;
}
...
export default function EditInvoiceModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Show whatever message the error actually carries, rather than
      // pattern-matching a specific literal string — the duplicate check
      // in InvoiceCreate.tsx throws "This invoice already exists" directly,
      // so this displays that (or any other thrown message) correctly
      // without needing to know the exact wording in advance.
      toast.error(
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        ...
        <div className="flex flex-col gap-4 sm:gap-5 mt-4">
          ...
          {/* Amount, Taxable amount, Invoice number */}
...
//         toast.error("This invoice already exists");
//       } else {
